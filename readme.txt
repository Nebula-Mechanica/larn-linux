     ...
     past two years. This version is for the Win32 environment.
     ...
     Win32 LARN requires:
       ...
       - Any Win32 compatible OS.

       - at least 2MB of RAM.

       - disk storage capacity of at least 500KB.
     ...
     -----------------
       ...
       larn.bat          Run this to play the game.

       scores.bat        Run this to view the scoreboard.
	   
	   /bin				 Game files directory
	   
	   /src				 Game source code directory
	 ...
	 click "larn.bat" if you are using Windows Explorer.
